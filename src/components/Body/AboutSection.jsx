            ...
            <div className="grid gap-6 items-center lg:grid-cols-[repeat(2,_minmax(0,_1fr))] lg:gap-12">
                <div className="grid gap-6 h-fit lg:gap-8">
                    ...
                    <div className="grid gap-4">
                        <a className="w-fit flex items-center gap-2" href="https://www.linkedin.com/in/mylesglenngaerlan" target="_blank" rel="noopener noreferrer">
                        ...
                        <a className="w-fit flex items-center gap-2" href="https://github.com/ishmyles" target="_blank" rel="noopener noreferrer">
