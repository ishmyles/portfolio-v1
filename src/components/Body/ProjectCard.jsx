        ...
        <div className="grid gap-5 content-[start] ring-1 outline-solid ring-neutral-700 rounded-md p-4">
            ...
            <div className="flex justify-between">
                {appLink && <a href={appLink} target="_blank" className="flex gap-2 items-center font-(family-name:--font-electrolize) uppercase hover:text-(--accent-blue)">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="white" width={30} viewBox="0 0 24 24"><title>open-in-app</title><path d="M12,10L8,14H11V20H13V14H16M19,4H5C3.89,4 3,4.9 3,6V18A2,2 0 0,0 5,20H9V18H5V8H19V18H15V20H19A2,2 0 0,0 21,18V6A2,2 0 0,0 19,4Z" /></svg> 
                    <span>Go to App</span>
                </a>}
